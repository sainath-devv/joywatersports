...
export default function MinimalistLoader({ 
  message = "JOYWATERSPORTS", 
  subMessage = "Preparing Your Ocean Adventure...",
  fullScreen = true 
}: MinimalistLoaderProps) {
  if (fullScreen) {
    return (
      <div className="fixed inset-0 z-[999] bg-white flex flex-col items-center justify-center p-6 select-none font-sans">
        <div className="w-12 h-12 rounded-full border-4 border-blue-100 border-t-[#0077FF] animate-spin mb-4" />
